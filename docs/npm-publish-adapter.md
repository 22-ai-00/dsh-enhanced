...
The [read-only preparation record](evidence/npm-publish-preparation-readback-2026-09-19.json)
...
The [engineering validation record](evidence/npm-publish-adapter-engineering-2026-09-19.json)
