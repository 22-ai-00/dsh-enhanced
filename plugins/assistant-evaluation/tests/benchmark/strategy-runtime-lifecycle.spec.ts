...
function plan(): StrategyBenchmarkPlan {
  ...
  return { schemaVersion: 1, protocol: strategyBenchmarkProtocol, capabilities, execution: { modelCalls: 4, maxOutputTokensPerCall: 32, maxGoalRounds: 1, observationMode: 'enforced-upper-bound-provider-output' as const }, benchmark: { schemaVersion: 1, id: 'strategy-lifecycle', comparison: 'capability', dataset: { id: 'fixture', version: '1', digest: acceptanceDigest(task), split: 'development' }, cases: [{ id: 'case', domain: 'code', ...strategyGoalTaskDigests(task) }], budget: { durationMs: 20000, inputTokens: 100, outputTokens: 128, toolCalls: 2, costUsdMicros: null }, repeats: 2, seed: 1, variants: [{ id: 'direct', role: 'baseline', versions: { model: acceptanceDigest(model), skills: '0'.repeat(64), ...strategyBenchmarkCapabilityVersions(capabilities, false) }, features: { memory: false, planning: false, review: false, growth: false } }, { id: 'adaptive-strategy', role: 'candidate', versions: { model: acceptanceDigest(model), skills: '0'.repeat(64), ...strategyBenchmarkCapabilityVersions(capabilities, true) }, features: { memory: false, planning: false, review: false, growth: false } }] } }
}
