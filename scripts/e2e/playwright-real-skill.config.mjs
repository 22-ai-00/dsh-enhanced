...
export default defineConfig({
  ...
  outputDir: process.env.DSH_WEB_REAL_SKILL_COMPARE === '1' ? '../../.cache/web-owner-real-comparison-e2e' : process.env.DSH_WEB_REAL_SKILL_CANDIDATE === '1' ? '../../.cache/web-owner-real-candidate-e2e' : '../../.cache/web-owner-real-skill-e2e', reporter: 'list',
